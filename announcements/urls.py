...
urlpatterns = [
    ...
    url(r'^logout/$', aviews.logout, { 'next_page': 'announce:index' } , name='logout'),
    url(r'^admin/', include(admin.site.urls)),
    url(r'^.*$', RedirectView.as_view(url=('%s/%s'%(settings.MYURL,'announce/')), permanent=False), name='redirect_to_index')
]
